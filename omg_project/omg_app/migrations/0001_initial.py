# Generated by Django 4.2.6 on 2023-10-20 02:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_status",
                    models.IntegerField(
                        choices=[(0, "무료"), (1, "프로"), (2, "프로플러스"), (3, "엔터프라이즈")],
                        default=0,
                        verbose_name="결제 상태",
                    ),
                ),
                (
                    "registered_date",
                    models.DateTimeField(auto_now=True, verbose_name="가입일"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_message",
                    models.CharField(default="대화를 시작해보세요!", verbose_name="마지막 메세지"),
                ),
                (
                    "model_id",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_date",
                    models.DateTimeField(auto_now_add=True, verbose_name="게시일"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "merchant_id",
                    models.UUIDField(
                        default=uuid.uuid4, editable=False, verbose_name="가맹점 코드"
                    ),
                ),
                (
                    "amount",
                    models.PositiveIntegerField(default=100, verbose_name="결제 금액"),
                ),
                (
                    "payment_date",
                    models.DateTimeField(auto_now_add=True, verbose_name="결제 갱신일"),
                ),
                (
                    "payment_type",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_user",
                    models.BooleanField(default=True, verbose_name="사용자가 보낸 메세지 인지"),
                ),
                (
                    "chat_id",
                    models.ForeignKey(
